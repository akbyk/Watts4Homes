...
export const mockHomes: HomeStatus[] = [
  {
    ...
    budgetQuota: 0.5,
    appliances: [
      { applianceId: 1, safeLimitWatts: 200, consecutiveBreachCount: 0, status: "NORMAL" },
      { applianceId: 2, safeLimitWatts: 2500, consecutiveBreachCount: 0, status: "NORMAL" },
      { applianceId: 3, safeLimitWatts: 2000, consecutiveBreachCount: 0, status: "NORMAL" },
      { applianceId: 4, safeLimitWatts: 2200, consecutiveBreachCount: 0, status: "NORMAL" },
    ],
  },
  {
    homeId: 2,
    ...
    budgetQuota: 0.5,
    appliances: [
      { applianceId: 5, safeLimitWatts: 200, consecutiveBreachCount: 0, status: "NORMAL" },
      { applianceId: 6, safeLimitWatts: 1800, consecutiveBreachCount: 2, status: "ANOMALOUS" },
      { applianceId: 7, safeLimitWatts: 1500, consecutiveBreachCount: 0, status: "NORMAL" },
    ],
  },
  {
    homeId: 3,
    ...
    budgetQuota: 0.5,
    appliances: [
      { applianceId: 8, safeLimitWatts: 2500, consecutiveBreachCount: 4, status: "ANOMALOUS" },
      { applianceId: 9, safeLimitWatts: 900, consecutiveBreachCount: 3, status: "ANOMALOUS" },
      { applianceId: 10, safeLimitWatts: 200, consecutiveBreachCount: 0, status: "NORMAL" },
    ],
  },
];
