...
export function HomeCard({
  ...
  return (
    <article
      onClick={onClick}
      className="group cursor-pointer rounded-[var(--radius-card)] border border-line bg-white p-5 transition hover:-translate-y-0.5 hover:shadow-[0_12px_32px_-16px_rgba(28,43,51,0.25)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-energy"
      tabIndex={0}
      role="button"
